    ...
    describe("execute", () => {
        it("should import transactions from the csv file", async () => {
            const mockPortfolioRepository: PortfolioRepository = {
                ...
                savePortfolio: jest.fn<void, [Portfolio]>()
            };

            const csvData = "Data operação,Categoria,Código Ativo,Operação C/V,Quantidade,Preço unitário,Corretora,Corretagem,Taxas,Impostos,IRRF\n" +
